...
# 关联远程仓库（替换为你的用户名）
git remote add origin https://github.com/anyunxiu/PlexRename/plexrename.git
```
...
在README.md顶部添加：
```markdown
![GitHub release (latest by date)](https://img.shields.io/github/v/release/anyunxiu/PlexRename)
![GitHub](https://img.shields.io/github/license/anyunxiu/PlexRename)
![GitHub stars](https://img.shields.io/github/stars/anyunxiu/PlexRename?style=social)
```
